...
<div class="row user-menu-bg">
	<ul class="no-padding user-menu">
		...
		<li><a href="<?=base_url('/yeu-cau-goi-lai.html')?>"><img src="<?=base_url('/img/icons/phone-icon.png')?>"><span class="mobile-hide"> Yêu cầu gọi lại</span></a> </li>
