		...
		<div class="col-lg-12 col-sm-12">
			...
			<div class="col-md-12 no-margin no-padding text-center">
				<div class="alert alert-success">
					<strong class="title">Đăng tin thành công!</strong> <?=$cooperate->Title?>
				</div>

				<div class="post-success">
					<div>Link đến tin rao: <a href="<?=base_url().seo_url($cooperate->Title).'-co'.$cooperate->CooperateID.'.html'?>"><?=base_url().seo_url($cooperate->Title).'-co'.$cooperate->CooperateID.'.html'?></a></div>
					<div>
						<i>
							<ol>
					...
					<div class="margin-top-20">
						<a href="<?=base_url('/dang-tin-hop-tac.html')?>">&raquo;Đăng tin mới</a>
						&nbsp;&nbsp;<a href="<?=base_url('/hop-tac.html')?>">&raquo;Đến danh mục</a>
