			...
			<div class="box">
				...
				<div class="box-body">
					...
					<div class="row no-margin top-buttons">
						<a class="btn btn-warning" href="<?=base_url("/order/list.html")?>">Trở lại</a>&nbsp;
						<a class="btn btn-primary" id="addNew" href="<?=base_url("/order/update-{$order->OrderID}.html")?>">Chỉnh sửa đơn hàng</a>
					</div>
